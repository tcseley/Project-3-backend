...
const show = async (req, res) => {
    ...
    try {
        ...
        console.log('Error inside of /api/attractions/:id');
        console.log(error);
...
const update = async (req, res) => {
    ...
    try {
        ...
        const updatedAttraction = await Attraction.update({ name: req.body.name }, req.body); // updating the attraction

        console.log(updatedAttraction); // { n: 1, nModified: 0, ok: 1 }
        console.log(attraction); // a attraction object 
